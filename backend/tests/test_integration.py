...
class TestIntegration:
    ...
    def test_end_to_end_query_processing_with_search(self, mock_config):
        ...
        with patch('rag_system.DocumentProcessor') as mock_doc_proc, \
            ...
            search_results = Mock()
            search_results.documents = ["Course content about MCP technology and its applications."]
            search_results.metadata = [{"course_title": "Introduction to MCP", "lesson_number": 0}]
            ...
            final_response = Mock()
            final_response.content = [Mock(text="MCP technology is a powerful framework for building AI agents.")]
            ...
            assert response == "MCP technology is a powerful framework for building AI agents."
    ...
    def test_end_to_end_query_without_search(self, mock_config):
        ...
        with patch('rag_system.DocumentProcessor'), \
            ...
            direct_response.content = [Mock(text="Python is a high-level programming language.")]
    ...
    def test_conversation_flow_with_context(self, mock_config):
        ...
        with patch('rag_system.DocumentProcessor'), \
            ...
            response2.content = [Mock(text="MCP can be used to build AI agents and tools.")]
    ...
    def test_document_processing_to_query_pipeline(self, mock_config, sample_courses, sample_course_chunks):
        ...
        with patch('rag_system.DocumentProcessor') as mock_doc_proc, \
            ...
            # Final response
            final_response = Mock()
            final_response.content = [Mock(text="Based on the course content, MCP provides an overview of technology.")]
            ...
            assert response == "Based on the course content, MCP provides an overview of technology."
            assert len(sources) > 0
    ...
    def test_error_propagation_through_system(self, mock_config):
        ...
        with patch('rag_system.DocumentProcessor'), \
            ...
            final_response = Mock()
            final_response.content = [Mock(text="I'm sorry, I couldn't search the course materials due to a technical issue.")]
    ...
    def test_tool_chain_execution_flow(self, mock_config):
        ...
        with patch('rag_system.DocumentProcessor'), \
            ...
            mock_vector_store.return_value._resolve_course_name.return_value = "Introduction to MCP"
            
            search_results = Mock()
            search_results.documents = ["MCP is a framework for building AI tools"]
            search_results.metadata = [{"course_title": "Introduction to MCP", "lesson_number": 1}]
            ...
            mock_vector_store.return_value.get_lesson_link.return_value = "https://example.com/mcp/lesson1"
            ...
            tool_content.input = {"query": "AI tools", "course_name": "MCP", "lesson_number": 1}
            tool_response.content = [tool_content]
            
            final_response = Mock()
            final_response.content = [Mock(text="MCP framework allows building sophisticated AI tools.")]
